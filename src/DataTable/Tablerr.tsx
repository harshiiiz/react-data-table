...
import Header from '../DataTable/components/TableHeader';
import Subheader from '../DataTable/components/TableSubHeader';
...
export default React.memo(Tablerr) as typeof Tablerr;
